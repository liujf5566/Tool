...
public class XmlText : XmlDocument
{
    ...
    {
        XmlAttributeCollection attributes = SelectSingleNode(xPath).Attributes;
    ...
    public void AddSection(XmlNode Parentelement, string Section)
    {
        ...
        XmlNode newElement = CreateElement(Section);
        XmlNode CommentElement = CreateNode(XmlNodeType.Comment, "NodeComment", null);
    ...
    {
        XmlNode ItemElement = CreateNode(XmlNodeType.Element, element, "");
    ...
    {
        XmlAttribute newKey = CreateAttribute(Key);
    ...
    private void CreateXml(string RootElement)
    {
        ...
        MainElement = CreateElement(RootElement);
        AppendChild(MainElement);
        XmlNode CommentElement = CreateNode(XmlNodeType.Comment, "MainComment", null);
